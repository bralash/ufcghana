...
<head>
    ...
    <title>Verify number | UFC Ghana</title>
...
<main>
    <div id="form_container">
        <div class="row">
            <div class="col-md-5">
                <div id="left_form">
                    <figure><img src="{{URL::asset('img/verify.png')}}" alt=""></figure>
                    <h2>Verify number</h2>
                    <p>
                        Enter the 4 digit code sent to your MM number
                    </p>
            ...
            <div class="col-md-7">
                ...
                <div id="wizard_container">
                    ...
                    <!-- /top-wizard -->
                    <form action="{{URL::to('auth/verify/')}}" id="wrapped" method="POST">
                        {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        <div class="form-group">
                                            <input type="text" name="v_code" class="form-control required" placeholder="Verification Code">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="bottom-wizard">
                            <button type="submit" name="process" class="submit">Verify</button>
                        </div>
                        <!-- /bottom-wizard -->
                    </form>
                </div>
