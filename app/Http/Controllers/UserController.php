...
//    }
    ...
    public function sms()
    {
        ...
        $clientId = 'cxdvnlbi';
        $clientSecret = 'vbjytixl';
        $url = "https://api.hubtel.com/v1/messages/send?From=UFC%2C+Ghana&To=%2B233256786234&Content=Testing&ClientId=cxdvnlbi&ClientSecret=vbjytixl&RegisteredDelivery=true";
